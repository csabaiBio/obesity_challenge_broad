...
def eval_precision(model,savePath:str = ""):
    ...
    with open(f"results/precision_all_gene_pearson{savePath}.pkl", "wb") as f:  
        pickle.dump(res_dict, f)
    print("Finished")


def debug_eval(model):
...
def eval_distribution(model,savePath:str = ""):
    # --- CONFIG ---
    ...
    # Save Results
    with open(f"results/distribution_all_gene{savePath}.pkl", "wb") as f:  
        pickle.dump(res_dict, f)
    print("Finished")
